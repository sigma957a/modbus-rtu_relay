...
Отправляет команды на разные Slave ID с задержкой 1 сек
...
def main():
    ...
    print()
    print("=" * 70)
    print("⚡ ДИАГНОСТИКА ВСЕХ ПОРТОВ GATEWAY (10 ЦИКЛОВ, 1 СЕК)")
    print("=" * 70)
    print()
    print("Переключение между портами с задержкой 1 сек")
    print("Повторяется 10 раз для наблюдения за LINK индикаторами")
    print()
    print("⚠️  СЛЕДИТЕ ЗА:")
    print("   - Индикаторы LINK1, LINK2, LINK3, LINK4 на Gateway")
    print("   - Напряжение на клеммах A и B каждого порта")
    print()
    
    # Настройки
    gateway_host = "192.168.1.254"
    gateway_port = 502
    delay = 1.0  # Увеличен интервал до 1 секунды
    cycles = 10
